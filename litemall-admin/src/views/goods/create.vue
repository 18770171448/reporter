  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        <el-form-item label="文章编号" prop="goodsSn">
          <el-input v-model="goods.goodsSn"/>
        </el-form-item>
        <el-form-item label="文章标题" prop="name">
          <el-input v-model="goods.name"/>
        </el-form-item>
        <el-form-item label="评分" prop="counterPrice">
          <el-input v-model="goods.counterPrice" placeholder="百分制">
            <template slot="append">分</template>
          </el-input>
        </el-form-item>
        <el-form-item label="是否原创" prop="isNew">
...
export default {
  ...
  data() {
    return {
      ...
      attributes: [],
      rules: {
        goodsSn: [{ required: true, message: '文章编号不能为空', trigger: 'blur' }],
        name: [{ required: true, message: '文章标题不能为空', trigger: 'blur' }],
        autor: [{ required: true, message: '作者姓名不能为空', trigger: 'blur' }]
      },
      editorInit: {
        language: 'zh_CN',
        convert_urls: false,
