...
public class AdminTopicController {
    ...
    @RequiresPermissionsDesc(menu = {"团内文件", "报纸发放"}, button = "查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu = {"团内文件", "报纸发放"}, button = "添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu = {"团内文件", "报纸发放"}, button = "详情")
    @GetMapping("/read")
    ...
    @RequiresPermissionsDesc(menu = {"团内文件", "报纸发放"}, button = "编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu = {"团内文件", "报纸发放"}, button = "删除")
    @PostMapping("/delete")
