...
public class AdminBrandController {
    ...
    @RequiresPermissionsDesc(menu = {"文章管理", "作者管理"}, button = "查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu = {"文章管理", "作者管理"}, button = "添加")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu = {"文章管理", "作者管理"}, button = "详情")
    @GetMapping("/read")
    ...
    @RequiresPermissionsDesc(menu = {"文章管理", "作者管理"}, button = "编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu = {"文章管理", "作者管理"}, button = "删除")
    @PostMapping("/delete")
